...
error_logs = [
    ...
    "SEVERE: Error writing to file\njava.io.IOException: No space left on device\n    at java.io.FileOutputStream.writeBytes(Native Method)\n    at java.io.FileOutputStream.write(Unknown Source)\n    ...",
    "SEVERE: Error connecting to external service\ncom.example.service.ServiceException: Failed to connect to service: timeout\n    at com.example.service.ExternalService.connect(ExternalService.java:87)\n    at com.example.service.ServiceClient.process(ServiceClient.java:55)\n    ..."
]
...
for i in range(1, num_log_files+1):
    ...
    with open(log_file_path, "w") as log_file:
        ...
        log_file.write(f"INFO: Starting process {process_name}...\n")
        log_file.write(f"INFO: Process {process_name} initialized.\n")
        log_file.write(f"DEBUG: Processing data...\n")
